...
const TaskItem = ({ task, handleEditSubmitter, editedText, setEditedText }) => {
  ...
  return (
    <div className='task-item flex justify-between items-center bg-gradient-to-r from-white-800 to-slate-800 p-5 rounded hover:from-white-900 hover:to-gray-800 group'>
      <div className='task-item-left flex gap-3'>
        <span className='self-center'>
          <input
            type='checkbox'
            className='accent-white-400 cursor-pointer'
            checked={isChecked}
